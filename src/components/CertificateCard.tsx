const CertificateCard = ({ title, subTitle, result, des, certificateLink }: any) => {
  return (
    <div className="w-full h-1/3 group flex">
      ...
      <div className="w-full bg-black bg-opacity-20 hover:bg-opacity-30 duration-300  rounded-lg p-4 lgl:px-10 flex flex-col justify-center gap-6 lgl:gap-10 shadow-shadowOne">
        ...
        {/* Add a button that links to your certificate (external link) */}
        <a href={certificateLink} target="_blank" rel="noopener noreferrer">
          <button className="px-4 py-2 bg-blue-500 text-white rounded-lg mt-2">
            View Certificate
          </button>
        </a>
      </div>
